...
user in an INI file next to VSCodium64Portable.exe called VSCodium64Portable.ini.
...
copy AppNamePortable.ini from this directory to VSCodium64Portable.ini next to
VSCodium64Portable.exe. The options in the INI file are as follows:
